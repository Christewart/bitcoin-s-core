...
trait BitcoindRpcTestUtil extends Logging {
  ...
  /** Returns a pair of [[org.bitcoins.rpc.client.v22.BitcoindV22RpcClient BitcoindV22RpcClient]]
    * that are connected with some blocks in the chain
    */
  def createNodePairV22(clientAccum: RpcClientAccum)(implicit
  system: ActorSystem): Future[(BitcoindV22RpcClient, BitcoindV22RpcClient)] =
